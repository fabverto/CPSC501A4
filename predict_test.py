...
Original file is located at
    https://colab.research.google.com/drive/1n2VSZ0VeKmI3olBgmWw45sNq8GGaLotO
...
def predict(model, class_names, img, true_label):
    ...
    #prediction = [1/10,1/10,1/10,1/10,1/10,1/10,1/10,1/10,1/10,1/10] <----------------Added code below
    prediction = model.predict(img)
    #Determine what the predicted label is
    #predicted_label = 0 <----------------------- Added code below
